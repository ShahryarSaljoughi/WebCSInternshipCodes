function createIconModule() {
  ...
  var icons = [
    ...
    },
    {
      ...
      svgHtml: `
      <svg preserveAspectRatio="none" class="icf-svg" viewBox="33 75 20 46">
    ...
    {
      cssClass: "rectangle-icon",
      svgHtml:`
      <svg preserveAspectRatio="none" viewBox="0 0 100 100" style="width: 100%; height: 100%;">
        <rect x="0" y="0" width="100%" heigh="100%" style="fill: inherit; stroke-width: 4;" />
      </svg>
      `
    }
  ]
